...
export default function MessageButton({ otherUserId }: { otherUserId: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={loading}
      className="w-full rounded-xl bg-[#3567F1] py-3 md:py-4 text-lg md:text-2xl font-semibold text-white shadow-sm transition hover:bg-[#2f5de0] disabled:opacity-50"
    >
