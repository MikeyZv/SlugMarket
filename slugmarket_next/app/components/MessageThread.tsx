    ...
    return (
        <>
            ...
            <div className="px-4 py-3 border-t border-gray-200 flex gap-2">
                ...
                />
                <button onClick={onSend} className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold px-4 py-2 rounded-full text-sm transition-colors">Send</button>
            </div>
        </>
    )
}
